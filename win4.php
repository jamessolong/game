                ...
                <div class="notification">
                        ...
                        <h1 class="c"><div>With <label id="score"></label> Score</div></h1>
                            ...
                            <br>
                              ...
                              <center>
                                <a class="button is-success is-medium is-rounded" href="level4.php" onclick="clearLocal()">Playagain</a> 
                                <br>
                                <br>
                                <a class="button is-success is-medium is-rounded" href="level5.php" onclick="clearLocal()">Next Level</a> 
                                <br>
                                <br>
